...
GUARDIAN_RS="${HOME}/.dotfiles/.scripts/shell-guardian.rs"
FAILSAFE_MODULE="${HOME}/.dotfiles/config/bash.d/01-failsafe.sh"
INSTALLER="${HOME}/.dotfiles/.scripts/install-shell-guardian.sh"
INTEGRITY_CHECKER="${HOME}/.dotfiles/.scripts/verify-failsafe-integrity.sh"
