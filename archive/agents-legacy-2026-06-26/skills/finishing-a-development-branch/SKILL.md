...
description: Use when implementation is complete, verification passes, and the remaining decision is how to integrate, merge, PR, clean up, or finish the branch.
---
...
**If worktree path is under `.worktrees/` or `worktrees/`:** the skill flow created this worktree, so we own cleanup.
